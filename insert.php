    ...
    <div class="container">
      <form id="contact" action="" method="post">
        ...
        <fieldset>
          ...
          <input  placeholder="Student ID" type="text" name="id">
        </fieldset>
        <fieldset>
...
{	 $id=$_POST['id'];
	 ...
	 $email = $_POST['email'];
    $phone=$_POST['phone'];
	 $sql = "INSERT INTO student (student_id,st_username,st_fname,st_lname,st_status,st_email,st_phone)
	 VALUES ('$id','$name','$first_name','$last_name','$status','$email','$phone')";
